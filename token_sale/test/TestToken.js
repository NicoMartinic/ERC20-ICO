...
contract('TestToken', function(accounts) {
    ...
    it('initializes the contract with the correct values', function() {
        return TestToken.deployed().then(function(instance) {
            ...
            assert.equal(symbol, 'TT', 'has the correct symbol');
    ...
    it('transfers token ownership', function() {
        ...
        return tokenInstance.transfer.call(accounts[1],250000, {from : accounts[0]});
            ...
            assert.equal(balance, 750000, 'deducts the amount from the sending account');
          });
    });
    ...
    it('handles delegated token transfers', function() {
        return TestToken.deployed().then(function(instance) {
          ...
          assert.equal(balance, 10, 'adds the amount from the receiving account');
